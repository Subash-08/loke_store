...
const ProductInfo: React.FC<ProductInfoProps> = ({
  ...
  const getCurrentPriceInfo = () => {
    ...
    return {
      ...
      hasDiscount: activeMrp > activePrice // Use base comparison to avoid drift
    };
  };
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <AddToCartButton
              ...
              className={`flex-1 bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-500 hover:to-yellow-600 text-gray-900 font-bold py-3.5 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed ${!canAddToCart ? 'opacity-50 cursor-not-allowed' : ''
                }`}
              quantity={1}
